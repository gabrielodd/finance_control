...
class DespesasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create despesa" do
    assert_difference('Despesa.count') do
      post despesas_url, params: { despesa: { categoria: @despesa.categoria, descricao: @despesa.descricao, valor: @despesa.valor } }
    end
  ...
  test "should update despesa" do
    patch despesa_url(@despesa), params: { despesa: { categoria: @despesa.categoria, descricao: @despesa.descricao, valor: @despesa.valor } }
